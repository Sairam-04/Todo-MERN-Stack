    ...
    <div className='header bg-[#2A2D33] flex justify-between items-center h-[9.5vh] px-5 py-2 border-b-[1px] border-[#6C717B] sticky top-0'>
      ...
      <div className='navright flex gap-3 items-center'>
        <div class="relative text-gray-600 focus-within:text-gray-400">
          ...
          <input type="search" name="q" class="py-2 text-sm text-white bg-[#2A2D33] rounded-2xl pl-10 focus:outline-none focus:bg-[#2A2D33] focus:text-white border border-[#6C717B]" placeholder="Search..." />
        </div>
